                            ...
                            <div class="col-lg-12">
                                <form action="/registration" method="post">
                                    ...
                                    <div class="form-group">
                                        <label>Login</label>
                                        <input type="text" class="form-control" name="login" placeholder="Login" required autofocus value="${registrationForm.login}" />
                                        <form:errors path="registrationForm.login" cssClass="alert alert-danger" element="div" />
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" class="form-control" name="email" placeholder="Email" required autofocus value="${registrationForm.email}" />
                                        <form:errors path="registrationForm.email" cssClass="alert alert-danger" element="div" />
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input type="password" class="form-control" name="password" placeholder="Password" required value="${registrationForm.password}" />
                                        <form:errors path="registrationForm.password" cssClass="alert alert-danger" element="div" />
                                    </div>
                                    <div class="form-group">
                                        <label>Confirm Password</label>
                                        <input type="password" class="form-control" name="confirmPassword" placeholder="Confirm Password" required value="${registrationForm.confirmPassword}" />
